...
*/
	public function getInfosVisiteur($login, $mdp){
             $req = "SELECT Visiteur.id as id, Visiteur.nom as nom, Visiteur.prenom as prenom,affectation.idnumImmat as idnumImmat 
from Visiteur, affectation
    ...
    */
    ...
    public function recupererImmat($idVisiteur){
       ...
       public function getListeVehicules($login, $mdp){
                $req = "select nom, idnumImmat, marque, modele, couleur from affectation, vehicule,Visiteur where Visiteur.id = affectation.idVisiteur and affectation.idnumImmat=vehicule.numImmat";
        //var_dump($req);
        $stmt = PdoGsb::$monPdo->prepare($req);
                $stmt->bindParam(':log', $login);
        $stmt->bindParam(':md', $mdp);
