...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // pg_gsb_frais_listevehicules
        if ($pathinfo === '/listevehicules') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\ListeVehiculesController::indexAction',  '_route' => 'pg_gsb_frais_listevehicules',);
        }
